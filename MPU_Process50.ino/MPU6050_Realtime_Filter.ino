...
void DEBUG_PRINT() {
  Serial.print(avg_GyroZ);  // gyro_z_avg
  Serial.print(';');
  Serial.print(avg_GyroX);  // gyro_x_avg
  Serial.print(';');
  Serial.print(stdev_AccY);  // acc_y_stdev
  Serial.print(';');
  Serial.print(stdev_GyroZ);  // gyro_z_stdev
  Serial.print(';');
  Serial.print(stdev_GyroX);  // gyro_x_stdev
  Serial.print(';');
  Serial.print(min_AccX);  // acc_x_min
  Serial.print(';');
  Serial.print(min_AccZ);  // acc_z_min
  Serial.print(';');
  Serial.print(min_GyroZ);  // gyro_z_min
  Serial.print(';');
  Serial.print(min_GyroX);  // gyro_x_min
  Serial.print(';');
  Serial.print(max_AccZ);  // acc_z_max
  Serial.print(';');
  Serial.print(max_GyroZ);  // gyro_z_max
  Serial.print(';');
  Serial.print(max_AccX);  // acc_x_max
  Serial.print(';');
  Serial.print(avg_AccY);  // acc_y_avg
  Serial.print(';');
  Serial.print(max_GyroX);  // gyro_x_max
  Serial.print(';');
  Serial.print(avg_GyroY);  // gyro_y_avg
  Serial.print(';');
  Serial.print(stdev_GyroY);  // gyro_y_stdev
  Serial.print(';');
  Serial.print(stdev_AccZ);  // acc_z_stdev
  Serial.print(';');
  Serial.print(stdev_AccX);  // acc_x_stdev
  Serial.print(';');
  Serial.print(min_GyroY);  // gyro_y_min
  Serial.print(';');
  Serial.print(min_AccY);  // acc_y_min
  Serial.print(';');
  Serial.print(max_GyroY);  // gyro_y_max
  Serial.print(';');
  Serial.print(max_AccY);  // acc_y_max
  Serial.print(';');
  Serial.print(avg_AccX);  // acc_x_avg
  Serial.print(';');
  Serial.print(avg_AccZ);  // acc_z_avg
  Serial.println(';');
}
